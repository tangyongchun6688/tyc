...
<script type="text/javascript" src="${pageContext.request.contextPath}/jsp/taskManage/pipelining/pipelining_update.js"></script>
</head>
<body>
<header>
    <!-- <div class="menu">
...
<!-- <article> -->
    ...
    <!-- <div class="pipe_cnt pipecreat_cnt"> -->
    	<h4 class="h4title">修改流水线<br><span class="f12 blue fn"></span></h4>
        	...
        	<li><b><em class="red f14"> * </em>流水线名称</b><input id="pip_name" name="pip_name" type="text" value="" placeholder=""></li>
        	 <li><b>定时执行</b>
            	<div class="timing_tab">
                    ...
                    <!-- <span><select><option value="00">每天</option><option selected>每周</option><option value="00">每月</option></select></span>
                    <span><select><option value="00">星期一</option><option value="00">星期二</option><option value="00">星期三</option><option value="00">星期四</option><option value="00">星期五</option><option value="00">星期六</option><option value="00">星期日</option></select></span> -->
                    <span>每天</span>
        ...
        <div class="pipebtn tc mb30"><a onclick="updatePip()">确认</a><a class="whitebtn"  onclick="returnPip();">返回</a></div>
    <!-- </div> -->
    </form>
<!-- </article> -->
</body>
